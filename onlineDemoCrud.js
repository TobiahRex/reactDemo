const Panel = ReactBootstrap.Panel, Accordion = ReactBootstrap.Accordion;
const Button = ReactBootstrap.Button, Input = ReactBootstrap.Input;
const ButtonToolbar = ReactBootstrap.ButtonToolbar;
const Modal = ReactBootstrap.Modal;
const OverlayTrigger = ReactBootstrap.OverlayTrigger;
const ListGroup = ReactBootstrap.ListGroup,ListGroupItem = ReactBootstrap.ListGroupItem;

// Load Recipe Items or set default Recipe Items
const recipes = (typeof localStorage["recipeBook"] != "undefined") ? JSON.parse(localStorage["recipeBook"]) : [
